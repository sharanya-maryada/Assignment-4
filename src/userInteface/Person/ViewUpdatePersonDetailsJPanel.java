...
import business.NumericVerifier;
...
public class ViewUpdatePersonDetailsJPanel extends javax.swing.JPanel {
    ...
    private void populatePatientDetails() {
        ...
        personHouseJTextField.setText(person.gethouse());
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(personHouseJTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void modifyTextFields(Boolean isEdit) {
        if (isEdit) {
            ...
            personHouseJTextField.setEnabled(true);
            ...
            personHouseJTextField.setEnabled(false);
    ...
    private Boolean checkBlankInput() {
            ...
            ||personAgeJTextField.getText().length()==0 || personCityJTextField.getText().length()==0 || personCommunityJTextField.getText().length() == 0
                || personHouseJTextField.getText().length() == 0){
            return false;
        } else {
            return true;
        }
